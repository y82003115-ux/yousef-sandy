(function(){
  const css=document.createElement('link');css.rel='stylesheet';css.href='mobile-ui.css';document.head.appendChild(css);
  const home=document.createElement('script');home.src='home-ui.js';document.body.appendChild(home);
  ...
  const giftPanel=document.querySelector('.gifts-mini');if(giftPanel){
    ...
    toggle.onclick=()=>giftPanel.classList.toggle('open');document.body.appendChild(toggle);
  }
})();
