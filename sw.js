const CACHE='ys-love-v10-20260720';
const ASSETS=['./','./index.html','./invites.js','./pwa.js','./home-ui.js','./mobile-ui.css','./manifest.webmanifest','./app-icon-3d.png','./romantic-3d-bg.png'];
